...
class Hint_DELTAK_2(set, metaclass=setmeta.FontDataMetaclass):
    """
    Objects representing Spark DELTAK2 opcodes. These are sets of DeltaSpec
    objects.
    """
    ...
    def __str__(self):
        ...
        ...   hint_deltaspec.DeltaSpec(28, 38, -0.125),
        ...   hint_deltaspec.DeltaSpec(31, 38, 0.25)})
        >>> print(obj)
        DELTAK: Point 31 -1/8@28, 1/4@31; Point 38 -1/8@28, 1/4@31
        """
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> utilities.hexdump(obj.binaryString(**d))
               0 | A802 001F 0026 0237  69                  |.....&.7i       |
        """
        
        band = 2  # hardwired for Hint_DELTAK_2
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAK_2 objects matching self, but where each
        ...
        ...     print(part)
        DELTAK: Point 31 -1/8@28
        DELTAK: Point 38 -1/8@28
        DELTAK: Point 31 1/4@31
        DELTAK: Point 38 1/4@31
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAK_2 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAK_2.fromvalidatedbytes
        >>> bs = utilities.fromhex("A8 02 00 1F 00 26 02 37 69")
        ...
        if op != 0xA8:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0xA8, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAK_2 from the specified walker.
