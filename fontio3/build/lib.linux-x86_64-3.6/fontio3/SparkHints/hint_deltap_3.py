...
class Hint_DELTAP_3(set, metaclass=setmeta.FontDataMetaclass):
    """
    ...
    def __str__(self):
        ...
        ...   hint_deltaspec.DeltaSpec(56, 49, -0.375)})
        >>> print(obj)
        DELTAP: Point 31 -1/8@44, 1/4@47; Point 49 -3/8@56
        """
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        ...   hint_deltaspec.DeltaSpec(47, 31, 0.25),
        ...   hint_deltaspec.DeltaSpec(56, 49, -0.375)})
        >>> d = {'band': 3, 'deltaBase': 9, 'deltaShift': 3}
        >>> utilities.hexdump(obj.binaryString(**d))
               0 | 7203 001F 3700 1F69  0031 F5             |r...7..i.1.     |
        """
        
        band = 3  # hardwired for Hint_DELTAP_3
        deltaBase = kwArgs.get('deltaBase', 9) + (16 * (band - 1))
        deltaShift = kwArgs.get('deltaShift', 3)
        grain = 2 ** (-deltaShift)
        w.add("BB", 0x72, len(self))
        d = self._makeDict()
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAP_3 objects matching self, but where each
        ...
        ...     print(part)
        DELTAP: Point 31 -1/8@44
        DELTAP: Point 31 1/4@47
        DELTAP: Point 49 -3/8@56
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAP_3 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAP_3.fromvalidatedbytes
        >>> bs = utilities.fromhex("72 03 00 1F 37 00 1F 69 00 31 F5")
        ...
        if op != 0x72:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0x72, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAP_3 from the specified walker.
