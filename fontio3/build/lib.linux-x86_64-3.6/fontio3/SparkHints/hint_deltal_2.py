...
class Hint_DELTAL_2(set, metaclass=setmeta.FontDataMetaclass):
    """
    Objects representing Spark DELTAL2 opcodes. These are sets of DeltaSpec
    objects.
    """
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAL_2 objects matching self, but where each
        ...
        ...     print(part)
        DELTAL: Point 31 -1/8@28
        DELTAL: Point 31 1/4@31
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAL_2 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAL_2.fromvalidatedbytes
        >>> bs = utilities.fromhex("AB 00 1F 02 37 69")
        ...
        if op != 0xAB:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0xAB, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAL_2 from the specified walker.
