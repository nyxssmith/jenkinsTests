...
"""
Support for mapping feature/setting values to associated masks in a 'morx'
table.
"""
...
from fontio3.morx import featureentry, featuresetting
...
class Features(list, metaclass=seqmeta.FontDataMetaclass):
    """
    Objects representing the subFeatureFlags in a 'morx' table (all chains
