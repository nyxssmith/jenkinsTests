...
class Hint_STROKEDELTA_2(set, metaclass=setmeta.FontDataMetaclass):
    """
    Objects representing Spark STROKEDELTA2 opcodes. These are sets of
    DeltaSpec objects.
    """
    ...
    def decompose(self):
        """
        Returns a list of Hint_STROKEDELTA_2 objects matching self, but where
        ...
        ...     print(part)
        STROKEDELTA: Point 31 -1/8@28
        STROKEDELTA: Point 31 1/4@31
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_STROKEDELTA_2 from the specified walker, with validation.
        ...
        >>> fvb = Hint_STROKEDELTA_2.fromvalidatedbytes
        >>> bs = utilities.fromhex("A3 00 1F 02 37 69")
        ...
        if op != 0xA3:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0xA3, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_STROKEDELTA_2 from the specified walker.
        ...
        >>> fb = Hint_STROKEDELTA_2.frombytes
        >>> bs = utilities.fromhex("A3 00 1F 02 37 69")
        >>> d = {'deltaBase': 9, 'deltaShift': 3}
        >>> print((fb(bs, **d)))
        STROKEDELTA: Point 31 -1/8@28, 1/4@31
