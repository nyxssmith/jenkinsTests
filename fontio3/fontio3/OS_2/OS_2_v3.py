...
"""
Support for Version 3 OS/2 tables.
"""
    ...
    if gidofx is not None:
        if not 0 <= gidofx < numGlyphs:
            logger.error((
              ...
              "corresponding to 'x' (%d) is out of range."))
...
class OS_2(object, metaclass=simplemeta.FontDataMetaclass):
    """
    Objects representing Version 3 OS/2 tables.
    ...
    attrSpec = dict(
        ...
        unicodeRanges = dict(
            attr_followsprotocol = True,
            attr_initfunc = unicoderanges_v3.UnicodeRanges,
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        ...
        >>> sbad = s[0:62] + b'\x02\x02' + s[64:]  # bad fsSelection
        ...
        if ver != 3:
            logger.error(('V0002', (), "Expected version 3"))
            return None
        ...
        v.append(
          unicoderanges_v3.UnicodeRanges.fromvalidatedwalker(w, **kwArgs))
    ...
    def fromversion2(cls, v2Obj, **kwArgs):
        """
        Returns a new version 3 OS_2 object from the specified version 2
        ...
        r = cls(
          # xAvgCharWidth is calculated a different way in v3, so don't bother
          # copying it over
          usWeightClass = v2Obj.usWeightClass,
          usWidthClass = v2Obj.usWidthClass,
          fsType = typeflags_v3.TypeFlags.fromversion2(v2Obj.fsType, **kwArgs),
          ySubscriptXSize = v2Obj.ySubscriptXSize,
          ySubscriptYSize = v2Obj.ySubscriptYSize,
          ySubscriptXOffset = v2Obj.ySubscriptXOffset,
          ySubscriptYOffset = v2Obj.ySubscriptYOffset,
          ySuperscriptXSize = v2Obj.ySuperscriptXSize,
          ySuperscriptYSize = v2Obj.ySuperscriptYSize,
          ySuperscriptXOffset = v2Obj.ySuperscriptXOffset,
          ySuperscriptYOffset = v2Obj.ySuperscriptYOffset,
          yStrikeoutSize = v2Obj.yStrikeoutSize,
          yStrikeoutPosition = v2Obj.yStrikeoutPosition,
          sFamilyClass = v2Obj.sFamilyClass,
          panoseArray = v2Obj.panoseArray,
          
          unicodeRanges = unicoderanges_v3.UnicodeRanges.fromversion2(
            v2Obj.unicodeRanges,
            **kwArgs),
          
          achVendID = v2Obj.achVendID,
          fsSelection = v2Obj.fsSelection,
          usFirstCharIndex = v2Obj.usFirstCharIndex,
          usLastCharIndex = v2Obj.usLastCharIndex,
          sTypoAscender = v2Obj.sTypoAscender,
          sTypoDescender = v2Obj.sTypoDescender,
          sTypoLineGap = v2Obj.sTypoLineGap,
          usWinAscent = v2Obj.usWinAscent,
          usWinDescent = v2Obj.usWinDescent,
          codePageRanges = v2Obj.codePageRanges,
          sxHeight = v2Obj.sxHeight,
          sCapHeight = v2Obj.sCapHeight,
          usDefaultChar = v2Obj.usDefaultChar,
          usBreakChar = v2Obj.usBreakChar,
          usMaxContext = v2Obj.usMaxContext)
    ...
    def fromwalker(cls, w, **kwArgs):
        ...
        ver = w.unpack("H")
        assert ver == 3  # caller must be using the right class
        v = [ver]
        v.extend(w.unpack("H2h"))
        v.append(typeflags_v3.TypeFlags.fromwalker(w, **kwArgs))
        v.extend(w.unpack("10hH"))
        v.append(panose.Panose(w, **kwArgs))
        v.append(unicoderanges_v3.UnicodeRanges.fromwalker(w, **kwArgs))
        v.append(w.unpack("4s"))
    ...
    def asVersion2(self, **kwArgs):
        """
        Returns a Version 2 OS_2 object from self.
        """
        
        return OS_2_v2.OS_2(
          # xAvgCharWidth is calculated a different way in v2,
          # so don't bother copying it over
          usWeightClass = self.usWeightClass,
          usWidthClass = self.usWidthClass,
          fsType = self.fsType.asVersion2(**kwArgs),
          ...
          unicodeRanges = self.unicodeRanges.asVersion2(**kwArgs),
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> utilities.hexdump(_testingValues[0].binaryString())
               0 | 0003 0000 0190 0005  0000 0000 0000 0000 |................|
        ...
        >>> utilities.hexdump(_testingValues[1].binaryString())
               0 | 0003 0258 0258 0008  0004 0000 0000 0000 |...X.X..........|
              10 | 0000 0000 0000 0000  0000 0000 0000 0000 |................|
...
if __debug__:
    ...
    _testingValues = (
        ...
        OS_2(
          ...
          unicodeRanges = unicoderanges_v3.UnicodeRanges(
            hasBasicLatin = True,
