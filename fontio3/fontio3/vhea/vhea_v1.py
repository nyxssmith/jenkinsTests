...
"""
Support for 'vhea' tables, version 1.0.
"""
...
def _validate(obj, **kwArgs):
    ...
    if obj.ascent < 0:
        logger.warning((
          'V0280',
          (obj.ascent,),
          "The ascent %d is negative; it should be negative."))
    
    if obj.descent > 0:
        logger.warning((
          'V0281',
          (obj.descent,),
          "The descent %d is positive; it should be negative."))
    
    if obj.lineGap:
        logger.error((
          'V0282',
          (obj.lineGap,),
          "The lineGap is %d, but zero is required."))
