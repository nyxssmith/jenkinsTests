...
"""
Support for single entries in a 'morx' table's feature subtable.
"""
...
from fontio3.morx import featuresetting
...
class FeatureEntry(object, metaclass=simplemeta.FontDataMetaclass):
    """
    Objects representing single entries in a 'morx' table's feature table.
    ...
    A note about 'morx' limitations: the featureSetting and featureType values
