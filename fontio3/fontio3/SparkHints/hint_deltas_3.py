...
class Hint_DELTAS_3(set, metaclass=setmeta.FontDataMetaclass):
    """
    Objects representing Spark DELTAS3 opcodes. These are sets of DeltaSpec
    objects.
    """
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAS_3 objects matching self, but where each
        ...
        ...     print(part)
        DELTAS: Point 31 -1/8@44
        DELTAS: Point 31 1/4@47
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAS_3 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAS_3.fromvalidatedbytes
        >>> bs = utilities.fromhex("AF 00 1F 02 37 69")
        ...
        if op != 0xAF:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0xAF, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAS_3 from the specified walker.
