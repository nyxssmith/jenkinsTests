...
"""
Support for format 19 embedded color emoji.
"""
...
class Format19(object, metaclass=simplemeta.FontDataMetaclass):
    """
    ...
    def binarySize(self):
        ...
        return 4 + len(self.image) # sizeof(ULONG) for the image length + the image data; metrics in CBLC
    
    def buildBinary(self, w, **kwArgs):
        """
        Adds the binary data for the Format19 object to the specified writer.
        
        >>> obj = _testingValues[1]
        >>> utilities.hexdump(obj.binaryString())
               0 | 0000 0017 0101 0101  0101 0101 0101 0101 |................|
              10 | 0101 0101 0101 0101  0101 01             |...........     |
        """
    ...
    def fromscaler(cls, scaler, glyphIndex, bitDepth, **kwArgs):
        """
        Initializes a Format19 object for glyphIndex using a scaler. The scaler
    ...
    def fromscalerdata(cls, glyphbitmap, bitDepth):
        """
        Initializes a Format19 from glyphbitmap, which should be an object
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Like fromwalker(), this method returns a new Format19. However, it also
        ...
        >>> fvb = Format19.fromvalidatedbytes
        >>> bm = _testingValues[1].metrics
        >>> obj = fvb(s, bigMetrics=bm, logger=logger)
        test.sbit.format19 - DEBUG - Walker has 27 remaining bytes.
        
        >>> fvb(s[:-1], bigMetrics=bm, logger=logger)
        test.sbit.format19 - DEBUG - Walker has 26 remaining bytes.
        test.sbit.format19 - ERROR - Insufficient data
        """
        
        logger = kwArgs.pop('logger', None)
        
        if logger is None:
            logger = logging.getLogger().getChild('format19')
        else:
            logger = logger.getChild('format19')
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Creates and returns a new Format19 object from the specified walker.
        
        >>> obj = _testingValues[1]
        >>> obj == Format19.frombytes(
        ...   obj.binaryString(),
