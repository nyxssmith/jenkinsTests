#
# codepageranges_v1.py
#
# Copyright © 2004-2015 Monotype Imaging Inc. All Rights Reserved.
#

"""
Support for representations of MS code page data for Version 1 OS/2 tables.
"""
...
_b8BitSmall = utilitiesbackend.utPack(
  "256B",
  *list(range(256)))

_b16BitBig = utilitiesbackend.utPack(
  "63232H",
  *(list(range(0x0100, 0xD800)) + list(range(0xE000, 0x10000))))
...
class CodePageRanges(object, metaclass=maskmeta.FontDataMetaclass):
    ...
    maskSorted = (
      ...
      'has1256', 'has1257', 'has874', 'has932', 'has936', 'has949', 'has950',
      'has1361', 'hasMacRoman', 'hasOEM', 'hasSymbol', 'has869', 'has866', 
      'has865', 'has864', 'has863', 'has862', 'has861', 'has860', 'has857', 
      'has855', 'has852', 'has775', 'has737', 'has708', 'has850', 'has437')
