...
"""
Support for representations of Unicode coverage data for Version 2 OS/2 tables.
"""
...
from fontio3.OS_2 import unicoderanges_v1
...
# The following is (mostly) mechanically generated by _generateUnicodeRanges_v2.py
_rangeData = {
    0: (100, f('0x20-0x7E')),
    1: (None, f('0xA0-0xFF')),
   ...
   59: (1, f('0x2E80-0x2E99, 0x2E9B-0x2EF3, 0x2F00-0x2FD5, 0x2FF0-0x2FFB, 0x3400-0x4DB5, 0x4E00-0x9FD5')),
...
class UnicodeRanges(object, metaclass=maskmeta.FontDataMetaclass):
    ...
    maskSorted = (
      ...
      'hasCombiningDiacriticalMarks', 'hasGreek', 'hasCyrillic', 'hasArmenian',
      'hasHebrew', 'hasArabic', 'hasDevanagari', 'hasBengali', 'hasGurmukhi',
      'hasGujarati', 'hasOriya', 'hasTamil', 'hasTelugu', 'hasKannada',
      'hasMalayalam', 'hasThai', 'hasLao', 'hasGeorgian', 'hasHangulJamo',
      ...
      'hasBopomofo', 'hasHangulCompatibilityJamo', 'hasCJKMiscellaneous',
      'hasCJKEnclosed', 'hasCJKCompatibility', 'hasHangulSyllables',
      'hasNonPlaneZero', 'hasCJKIdeographs', 'hasPlaneZeroPrivate',
      'hasCJKStrokes', 'hasAlphabeticPresentationForms',
    ...
    def fromversion1(cls, v1Obj, **kwArgs):
        """
        Returns a new version 2 UnicodeRanges object from the specified
        version 1 UnicodeRanges object. There is one keyword argument:
        ...
        r = cls(
          hasBasicLatin = v1Obj.hasBasicLatin,
          hasLatin1Supplement = v1Obj.hasLatin1Supplement,
          hasLatinExtendedA = v1Obj.hasLatinExtendedA,
          hasLatinExtendedB = v1Obj.hasLatinExtendedB,
          hasIPA = v1Obj.hasIPA,
          hasModifierLetters = v1Obj.hasModifierLetters,
          hasCombiningDiacriticalMarks = v1Obj.hasCombiningDiacriticalMarks,
          hasGreek = v1Obj.hasBasicGreek or v1Obj.hasGreekSymbolsAndCoptic,
          hasCyrillic = v1Obj.hasCyrillic,
          hasArmenian = v1Obj.hasArmenian,
          hasHebrew = v1Obj.hasBasicHebrew or v1Obj.hasHebrewExtended,
          hasArabic = v1Obj.hasBasicArabic or v1Obj.hasArabicExtended,
          hasDevanagari = v1Obj.hasDevanagari,
          hasBengali = v1Obj.hasBengali,
          hasGurmukhi = v1Obj.hasGurmukhi,
          hasGujarati = v1Obj.hasGujarati,
          hasOriya = v1Obj.hasOriya,
          hasTamil = v1Obj.hasTamil,
          hasTelugu = v1Obj.hasTelugu,
          hasKannada = v1Obj.hasKannada,
          hasMalayalam = v1Obj.hasMalayalam,
          hasThai = v1Obj.hasThai,
          hasLao = v1Obj.hasLao,
          hasGeorgian = v1Obj.hasBasicGeorgian or v1Obj.hasGeorgianExtended,
          hasHangulJamo = v1Obj.hasHangulJamo,
          hasLatinExtendedAdditional = v1Obj.hasLatinExtendedAdditional,
          hasGreekExtended = v1Obj.hasGreekExtended,
          hasPunctuation = v1Obj.hasPunctuation,
          hasSuperscriptsAndSubscripts = v1Obj.hasSuperscriptsAndSubscripts,
          hasCurrency = v1Obj.hasCurrency,
          hasSymbolCombiningDiacritics = v1Obj.hasSymbolCombiningDiacritics,
          hasLetterlike = v1Obj.hasLetterlike,
          hasNumberForms = v1Obj.hasNumberForms,
          hasArrows = v1Obj.hasArrows,
          hasMathematical = v1Obj.hasMathematical,
          hasMiscellaneousTechnical = v1Obj.hasMiscellaneousTechnical,
          hasControlPictures = v1Obj.hasControlPictures,
          hasOCR = v1Obj.hasOCR,
          hasEnclosed = v1Obj.hasEnclosed,
          hasBoxDrawing = v1Obj.hasBoxDrawing,
          hasBlockElements = v1Obj.hasBlockElements,
          hasGeometricShapes = v1Obj.hasGeometricShapes,
          hasMiscellaneousSymbols = v1Obj.hasMiscellaneousSymbols,
          hasDingbats = v1Obj.hasDingbats,
          hasCJKPunctuation = v1Obj.hasCJKPunctuation,
          hasHiragana = v1Obj.hasHiragana,
          hasKatakana = v1Obj.hasKatakana,
          hasBopomofo = v1Obj.hasBopomofo,
          hasHangulCompatibilityJamo = v1Obj.hasHangulCompatibilityJamo,
          hasCJKMiscellaneous = v1Obj.hasCJKMiscellaneous,
          hasCJKEnclosed = v1Obj.hasCJKEnclosed,
          hasCJKCompatibility = v1Obj.hasCJKCompatibility,
          hasHangulSyllables = v1Obj.hasHangulSyllables,
          hasCJKIdeographs = v1Obj.hasCJKIdeographs,
          hasPlaneZeroPrivate = v1Obj.hasPlaneZeroPrivate,
          hasCJKStrokes = v1Obj.hasCJKStrokes,
          hasAlphabeticPresentationForms = v1Obj.hasAlphabeticPresentationForms,
          hasArabicPresentationFormsA = v1Obj.hasArabicPresentationFormsA,
          hasCombiningHalfMarks = v1Obj.hasCombiningHalfMarks,
          hasVerticalForms = v1Obj.hasVerticalForms,
          hasSmallFormVariants = v1Obj.hasSmallFormVariants,
          hasArabicPresentationFormsB = v1Obj.hasArabicPresentationFormsB,
          hasHalfAndFullWidthForms = v1Obj.hasHalfAndFullWidthForms,
          hasSpecials = v1Obj.hasSpecials)
    ...
    def asVersion1(self, **kwArgs):
        """
        Returns a version 1 UnicodeRanges object from the data in self. There
        ...
        r = unicoderanges_v1.UnicodeRanges(
          ...
          hasBasicGreek = self.hasGreek,
          hasGreekSymbolsAndCoptic = self.hasGreek,
          hasCyrillic = self.hasCyrillic,
          hasArmenian = self.hasArmenian,
          hasBasicHebrew = self.hasHebrew,
          hasHebrewExtended = self.hasHebrew,
          hasBasicArabic = self.hasArabic,
          hasArabicExtended = self.hasArabic,
          ...
          hasLao = self.hasLao,
          hasBasicGeorgian = self.hasGeorgian,
          hasGeorgianExtended = self.hasGeorgian,
          ...
          hasCJKMiscellaneous = self.hasCJKMiscellaneous,
