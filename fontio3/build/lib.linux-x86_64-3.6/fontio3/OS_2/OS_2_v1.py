...
"""
Support for Version 1 OS/2 tables.
"""
...
class OS_2(object, metaclass=simplemeta.FontDataMetaclass):
    """
    Objects representing Version 1 OS/2 tables.
    ...
    attrSpec = dict(
        ...
        unicodeRanges = dict(
            attr_followsprotocol = True,
            attr_initfunc = unicoderanges_v1.UnicodeRanges,
        ...
        codePageRanges = dict(
            attr_followsprotocol = True,
            attr_initfunc = codepageranges_v1.CodePageRanges,
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        ...
        if ver != 1:
            logger.error(('V0002', (), "Expected version 1"))
            return None
        ...
        v.append(obj)
        obj = unicoderanges_v1.UnicodeRanges.fromvalidatedwalker(w, **kwArgs)
        ...
        obj = codepageranges_v1.CodePageRanges.fromvalidatedwalker(w, **kwArgs)
    ...
    def fromversion0(cls, v0Obj, **kwArgs):
        """
        Returns a new OS_2 object from the specified version 0 (Windows)
        ...
        r = cls(
          xAvgCharWidth = v0Obj.xAvgCharWidth,
          usWeightClass = v0Obj.usWeightClass,
          usWidthClass = v0Obj.usWidthClass,
          fsType = v0Obj.fsType,
          ySubscriptXSize = v0Obj.ySubscriptXSize,
          ySubscriptYSize = v0Obj.ySubscriptYSize,
          ySubscriptXOffset = v0Obj.ySubscriptXOffset,
          ySubscriptYOffset = v0Obj.ySubscriptYOffset,
          ySuperscriptXSize = v0Obj.ySuperscriptXSize,
          ySuperscriptYSize = v0Obj.ySuperscriptYSize,
          ySuperscriptXOffset = v0Obj.ySuperscriptXOffset,
          ySuperscriptYOffset = v0Obj.ySuperscriptYOffset,
          yStrikeoutSize = v0Obj.yStrikeoutSize,
          yStrikeoutPosition = v0Obj.yStrikeoutPosition,
          sFamilyClass = v0Obj.sFamilyClass,
          panoseArray = v0Obj.panoseArray,
          achVendID = v0Obj.achVendID,
          fsSelection = v0Obj.fsSelection,
          usFirstCharIndex = v0Obj.usFirstCharIndex,
          usLastCharIndex = v0Obj.usLastCharIndex,
          sTypoAscender = v0Obj.sTypoAscender,
          sTypoDescender = v0Obj.sTypoDescender,
          sTypoLineGap = v0Obj.sTypoLineGap,
          usWinAscent = v0Obj.usWinAscent,
          usWinDescent = v0Obj.usWinDescent)
    ...
    def fromwalker(cls, w, **kwArgs):
        ...
        ver = w.unpack("H")
        assert ver == 1  # caller must be using the right class
        v = [ver]
        v.extend(w.unpack("H2h"))
        v.append(typeflags_v0.TypeFlags.fromwalker(w, **kwArgs))
        v.extend(w.unpack("10hH"))
        v.append(panose.Panose(w, os2panver=0, **kwArgs))
        v.append(unicoderanges_v1.UnicodeRanges.fromwalker(w, **kwArgs))
        v.append(w.unpack("4s"))
        v.append(selection_v0.Selection.fromwalker(w, **kwArgs))
        v.extend(w.unpack("2H3h2H"))
        v.append(codepageranges_v1.CodePageRanges.fromwalker(w, **kwArgs))
        return cls(*v)
    ...
    def asVersion0(self, **kwArgs):
        """
        Returns a Version 0 (Windows) OS_2 object from self.
        """
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> utilities.hexdump(_testingValues[0].binaryString())
               0 | 0001 0000 0190 0005  0000 0000 0000 0000 |................|
        ...
        >>> utilities.hexdump(_testingValues[1].binaryString())
               0 | 0001 0258 0258 0008  0004 0000 0000 0000 |...X.X..........|
              10 | 0000 0000 0000 0000  0000 0000 0000 0000 |................|
...
if __debug__:
    ...
    _testingValues = (
        ...
        OS_2(
          ...
          unicodeRanges = unicoderanges_v1.UnicodeRanges(hasBasicLatin=True, hasLatin1Supplement=True),
          fsSelection = selection_v0.Selection(strikeout=True),
          sTypoAscender = 1400,
          sTypoDescender = -800,
          codePageRanges = codepageranges_v1.CodePageRanges(has1252=True, has1255=True)))
