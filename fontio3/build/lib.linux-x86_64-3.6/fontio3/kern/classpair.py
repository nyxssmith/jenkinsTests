...
"""
Support for keys for class-based kerning (in 'kern' tables).
"""
...
class ClassPair(tuple, metaclass=seqmeta.FontDataMetaclass):
    """
    Objects representing a pair of classes. These are tuples, and are used as
    keys in Format2 objects.
    ...
    val.[0] - ERROR - The class index -1 cannot be used in an unsigned field.
    val.[1] - ERROR - The class index 2.5 is not an integer.
    False
    """
