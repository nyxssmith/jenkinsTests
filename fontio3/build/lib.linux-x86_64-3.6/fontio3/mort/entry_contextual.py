...
"""
Single entries for a contextual substitution 'mort' subtable.
"""

# Other imports
from fontio3.fontdata import simplemeta
from fontio3.mort import glyphdict
...
def _ppf(p, obj, **k):
    ...
    if obj.markSubstitutionDict:
        ...
        if obj.currSubstitutionDict:
            p.deep(obj.currSubstitutionDict, label="and changing the current glyph thus", **k)
