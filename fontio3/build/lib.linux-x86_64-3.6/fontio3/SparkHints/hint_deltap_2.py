...
class Hint_DELTAP_2(set, metaclass=setmeta.FontDataMetaclass):
    """
    ...
    def __str__(self):
        ...
        ...   hint_deltaspec.DeltaSpec(40, 49, -0.375)})
        >>> print(obj)
        DELTAP: Point 31 -1/8@28, 1/4@31; Point 49 -3/8@40
        """
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        ...   hint_deltaspec.DeltaSpec(31, 31, 0.25),
        ...   hint_deltaspec.DeltaSpec(40, 49, -0.375)})
        >>> d = {'band': 2, 'deltaBase': 9, 'deltaShift': 3}
        >>> utilities.hexdump(obj.binaryString(**d))
               0 | 7103 001F 3700 1F69  0031 F5             |q...7..i.1.     |
        """
        
        band = 2  # hardwired for Hint_DELTAP_2
        deltaBase = kwArgs.get('deltaBase', 9) + (16 * (band - 1))
        deltaShift = kwArgs.get('deltaShift', 3)
        grain = 2 ** (-deltaShift)
        w.add("BB", 0x71, len(self))
        d = self._makeDict()
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAP_2 objects matching self, but where each
        ...
        ...     print(part)
        DELTAP: Point 31 -1/8@28
        DELTAP: Point 31 1/4@31
        DELTAP: Point 49 -3/8@40
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAP_2 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAP_2.fromvalidatedbytes
        >>> bs = utilities.fromhex("71 03 00 1F 37 00 1F 69 00 31 F5")
        ...
        if op != 0x71:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0x71, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAP_2 from the specified walker.
