...
class Hint_DELTAS_1(set, metaclass=setmeta.FontDataMetaclass):
    """
    Objects representing Spark DELTAS1 opcodes. These are sets of DeltaSpec
    objects.
    """
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAS_1 objects matching self, but where each
        ...
        ...     print(part)
        DELTAS: Point 31 -1/8@12
        DELTAS: Point 31 1/4@15
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAS_1 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAS_1.fromvalidatedbytes
        >>> bs = utilities.fromhex("AD 00 1F 02 37 69")
        ...
        if op != 0xAD:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0xAD, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAS_1 from the specified walker.
