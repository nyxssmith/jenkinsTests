#
# GDEF_v0.py -- Top-level support for GDEF tables (prior to OpenType 1.6)
#
# Copyright © 2005-2017 Monotype Imaging Inc. All Rights Reserved.
#

"""
Support for GDEF tables (prior to OpenType 1.6).
"""
...
from fontio3.GDEF import attachlist, glyphclass, ligcaret, markclass
...
class GDEF(object, metaclass=simplemeta.FontDataMetaclass):
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> utilities.hexdump(_testingValues[1].binaryString())
               0 | 0001 0000 000C 0028  004A 0076 0002 0004 |.......(.J.v....|
              10 | 0004 0006 0002 0007  0007 0001 000A 000B |................|
              20 | 0002 000F 000F 0002  000A 0003 0014 001C |................|
              30 | 001C 0001 0003 002D  0032 0062 0003 0003 |.......-.2.b....|
              40 | 0013 0014 0002 0001  0004 0008 0002 0010 |................|
              50 | 0014 0001 0002 0047  0062 0001 0008 0001 |.......G.b......|
              60 | 0008 0001 01F4 0003  01F4 0006 000C 0011 |................|
              70 | 0002 EF00 1200 0002  0004 0004 0006 0002 |................|
              80 | 0007 0007 0001 000A  000B 0002 000F 000F |................|
              90 | 0002                                     |..              |
        """
    ...
    def fromValidatedFontWorkerSource(cls, fws, **kwArgs):
        ...
        line = next(fws)
        if line != firstLine:
            logger.error(('V0958', (firstLine, line),
                'line 1 -- expected \'%s\', found \'%s\''))
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        ...
        test.GDEF - DEBUG - Walker has 146 remaining bytes.
        test.GDEF.version - DEBUG - Walker has 146 remaining bytes.
        test.GDEF.glyphclass.classDef - DEBUG - Walker has 134 remaining bytes.
        ...
        test.GDEF.attachlist.coverage - DEBUG - Walker has 96 remaining bytes.
        ...
        test.GDEF.ligcaret - DEBUG - Walker has 72 remaining bytes.
        test.GDEF.ligcaret.coverage - DEBUG - Walker has 64 remaining bytes.
        ...
        test.GDEF.ligcaret.[0].ligglyph - DEBUG - Walker has 56 remaining bytes.
        test.GDEF.ligcaret.[0].ligglyph - INFO - Number of splits: 1.
        test.GDEF.ligcaret.[0].ligglyph.[0].caretvalue.coordinate - DEBUG - Walker has 48 remaining bytes.
        test.GDEF.ligcaret.[1].ligglyph - DEBUG - Walker has 52 remaining bytes.
        test.GDEF.ligcaret.[1].ligglyph - INFO - Number of splits: 1.
        test.GDEF.ligcaret.[1].ligglyph.[0].caretvalue.device - DEBUG - Walker has 44 remaining bytes.
        test.GDEF.ligcaret.[1].ligglyph.[0].caretvalue.device.device - DEBUG - Walker has 38 remaining bytes.
        ...
        test.GDEF.markclass.classDef - DEBUG - Walker has 28 remaining bytes.
