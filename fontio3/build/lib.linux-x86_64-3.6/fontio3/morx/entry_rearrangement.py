...
"""
Definitions of a rearrangement action for a 'morx' rearrangement subtable.
"""

# Other imports
from fontio3.fontdata import simplemeta
from fontio3.morx import verbs_rearrangement
...
class Entry(object, metaclass=simplemeta.FontDataMetaclass):
    ...
    def isSignificant(self):
        ...
        if self.markFirst or self.markLast or self.noAdvance:
            return True
