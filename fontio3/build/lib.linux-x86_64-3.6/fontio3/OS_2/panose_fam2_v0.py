...
"""
Support for representations of PANOSE data for OS/2 tables version 1 and
older, specifically for family 2 (Latin Text).
"""
...
class Panose_fam2(object, metaclass=maskmeta.FontDataMetaclass):
    ...
    def converted(self, **kwArgs):
        ...
        if kwArgs.get('returnTokens', False):
            ...
            return [CT('To Panose for OS/2 v2 or newer', _asV2)]
