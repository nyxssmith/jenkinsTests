...
"""
Support for single floating-point values used as entries in AxisValue objects.
These are essentially values along one axis.
"""
...
class AxialCoordinate(float, metaclass=valuemeta.FontDataMetaclass):
    """
    Single floating-point values, used in AxisValue objects. Note that they
    have a custom __str__() method to display to three places only, although
    the actual data value is always preserved.
    """
