...
class Hint_DELTAL_3(set, metaclass=setmeta.FontDataMetaclass):
    """
    Objects representing Spark DELTAL3 opcodes. These are sets of DeltaSpec
    objects.
    """
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAL_3 objects matching self, but where each
        ...
        ...     print(part)
        DELTAL: Point 31 -1/8@44
        DELTAL: Point 31 1/4@47
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAL_3 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAL_3.fromvalidatedbytes
        >>> bs = utilities.fromhex("AC 00 1F 02 37 69")
        ...
        if op != 0xAC:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0xAC, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAL_3 from the specified walker.
