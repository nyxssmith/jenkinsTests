...
"""
Support for single states in a 'mort' insertion subtable.
"""
...
class StateRow(dict, metaclass=mapmeta.FontDataMetaclass):
    ...
    subtable in a 'mort' table. These are dicts mapping class names to Entry
    objects.
...
if __debug__:
    from fontio3.mort import entry_insertion
