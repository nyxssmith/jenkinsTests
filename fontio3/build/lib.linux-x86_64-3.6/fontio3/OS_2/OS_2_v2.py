...
"""
Support for Version 2 OS/2 tables.
"""
    ...
    if gidofH is not None:
        if not 0 <= gidofH < numGlyphs:
            logger.error((
              'Vxxxx',
              (gidofH,),
              "sCapHeight value could not be validated because "
              "the glyph corresponding to 'H' (%d) is out of range "
              "for the font."))
    ...
    if gidofx is not None:
        if not 0 <= gidofx < numGlyphs:
            logger.error((
              'Vxxxx',
              (gidofx,),
              "sxHeight value could not be validated because "
              "the glyph corresponding to 'x' (%d) is out of range "
              "for the font."))
...
class OS_2(object, metaclass=simplemeta.FontDataMetaclass):
    """
    Objects representing Version 2 OS/2 tables.
    ...
    attrSpec = dict(
        ...
        fsType = dict(
            ...
            attr_initfunc = typeflags_v2.TypeFlags,
        ...
        unicodeRanges = dict(
            attr_followsprotocol = True,
            attr_initfunc = unicoderanges_v2.UnicodeRanges,
        ...
        sxHeight = dict(
            ...
            attr_label = "x-Height",
            attr_scaledirect = True,
            attr_recalculatefunc = _recalc_sxHeight,
            attr_representsy = True,
        ...
        sCapHeight = dict(
            ...
            attr_scaledirect = True,
            attr_recalculatefunc = _recalc_sCapHeight,
            attr_representsy = True,
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        ...
        if ver != 2:
            logger.error(('V0002', (), "Expected version 2"))
            return None
        
        v = [ver]
        okToReturn = True
        v.extend(w.unpack("H2h"))
        v.append(typeflags_v2.TypeFlags.fromvalidatedwalker(w, **kwArgs))
        ...
        v.append(
          unicoderanges_v2.UnicodeRanges.fromvalidatedwalker(w, **kwArgs))
        
        if v[-1] is None:
            okToReturn = False
        
        v.append(w.unpack("4s"))
        v.append(selection_v0.Selection.fromvalidatedwalker(w, **kwArgs))
    ...
    def fromversion1(cls, v1Obj, **kwArgs):
        """
        Returns a new version 2 OS_2 object from the specified version 1
        ...
        ct = v1Obj.panoseArray.converted(returnTokens=True)
        if ct:
            panV2 = v1Obj.panoseArray.converted(useToken=ct[0])
        else:
            panV2 = v1Obj.panoseArray
        
        r = cls(
          xAvgCharWidth = v1Obj.xAvgCharWidth,
          usWeightClass = v1Obj.usWeightClass,
          usWidthClass = v1Obj.usWidthClass,
          fsType = typeflags_v2.TypeFlags.fromversion0(v1Obj.fsType, **kwArgs),
          ySubscriptXSize = v1Obj.ySubscriptXSize,
          ySubscriptYSize = v1Obj.ySubscriptYSize,
          ySubscriptXOffset = v1Obj.ySubscriptXOffset,
          ySubscriptYOffset = v1Obj.ySubscriptYOffset,
          ySuperscriptXSize = v1Obj.ySuperscriptXSize,
          ySuperscriptYSize = v1Obj.ySuperscriptYSize,
          ySuperscriptXOffset = v1Obj.ySuperscriptXOffset,
          ySuperscriptYOffset = v1Obj.ySuperscriptYOffset,
          yStrikeoutSize = v1Obj.yStrikeoutSize,
          yStrikeoutPosition = v1Obj.yStrikeoutPosition,
          sFamilyClass = v1Obj.sFamilyClass,
          panoseArray = panV2,
          
          unicodeRanges = unicoderanges_v2.UnicodeRanges.fromversion1(
            v1Obj.unicodeRanges,
            **kwArgs),
          
          achVendID = v1Obj.achVendID,
          fsSelection = v1Obj.fsSelection,
          usFirstCharIndex = v1Obj.usFirstCharIndex,
          usLastCharIndex = v1Obj.usLastCharIndex,
          sTypoAscender = v1Obj.sTypoAscender,
          sTypoDescender = v1Obj.sTypoDescender,
          sTypoLineGap = v1Obj.sTypoLineGap,
          usWinAscent = v1Obj.usWinAscent,
          usWinDescent = v1Obj.usWinDescent,
          
          codePageRanges = codepageranges_v2.CodePageRanges.fromversion1(
            v1Obj.codePageRanges,
            **kwArgs))
    ...
    def fromwalker(cls, w, **kwArgs):
        ...
        ver = w.unpack("H")
        assert ver == 2  # caller must be using the right class
        v = [ver]
        v.extend(w.unpack("H2h"))
        v.append(typeflags_v2.TypeFlags.fromwalker(w, **kwArgs))
        v.extend(w.unpack("10hH"))
        v.append(panose.Panose(w, **kwArgs))
        v.append(unicoderanges_v2.UnicodeRanges.fromwalker(w, **kwArgs))
        v.append(w.unpack("4s"))
    ...
    def asVersion1(self, **kwArgs):
        """
        Returns a Version 1 OS_2 object from self.
        """
        
        panV0 = self.panoseArray.converted
        if ct:
            panV0 = self.panoseArray.converted(useToken=ct[0])
        else:
            panV0 = self.panoseArray        
        
        return OS_2_v1.OS_2(
          xAvgCharWidth = self.xAvgCharWidth,
          usWeightClass = self.usWeightClass,
          usWidthClass = self.usWidthClass,
          fsType = self.fsType.asVersion0(**kwArgs),
          ...
          panoseArray = panV0,
          unicodeRanges = self.unicodeRanges.asVersion1(**kwArgs),
          ...
          codePageRanges = self.codePageRanges.asVersion1(**kwArgs))
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> utilities.hexdump(_testingValues[0].binaryString())
               0 | 0002 0000 0190 0005  0000 0000 0000 0000 |................|
        ...
        >>> utilities.hexdump(_testingValues[1].binaryString())
               0 | 0002 0258 0258 0008  0004 0000 0000 0000 |...X.X..........|
              10 | 0000 0000 0000 0000  0000 0000 0000 0000 |................|
