...
"""
Definitions for version 2 'prop' tables.
"""
...
from fontio3.prop import glyphproperties_v2, prop_v1
...
class Prop(dict, metaclass=mapmeta.FontDataMetaclass):
    """
    Objects representing version 2 'prop' tables. These are dicts mapping glyph
    ...
    >>> utilities.hexdump(d.binaryString())
           0 | 0002 0000 0001 0000  0008 000C 0003 8080 |................|
          10 | 8080 8080                                |....            |
    
    >>> d = Prop.fromkeys(range(50), p1)
    >>> d[4] = d[42] = d[43] = d[44] = p2
    >>> utilities.hexdump(d.binaryString())
           0 | 0002 0000 0001 0000  0002 0006 0002 000C |................|
    ...
    GP = glyphproperties_v2.GlyphProperties
    tableVersion = 0x20000
    ...
    def asVersion1(self, **kwArgs):
        """
        Creates and returns a new version 1 Prop object from self.
        ...
        >>> 12 in dOld
        True
        >>> dOld[12].attachesRight
        Traceback (most recent call last):
          ...
        AttributeError: 'GlyphProperties' object has no attribute 'attachesRight'
        """
        
        f = self.GP.asVersion1  # unbound
        return prop_v1.Prop({k: f(v) for k, v in self.items()})
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> d[12] = d[13] = d[14] = p2
        >>> utilities.hexdump(d.binaryString())
               0 | 0002 0000 0001 0000  0008 000C 0003 8000 |................|
              10 | 8000 8000                                |....            |
    ...
    def fromversion1(cls, v1Obj, **kwArgs):
        """
        Creates and returns a new version 2 Prop object using the data in the
        specified version 1 object.
        """
        
        f = cls.GP.fromversion1
        return cls({k: f(v) for k, v in v1Obj.items()})
