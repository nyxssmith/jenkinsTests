...
def _validate(d, **kwArgs):
    ...
    logger.warning((
      'Vxxxx',
      (),
      "STAT is version 1.0 which has been deprecated. "
      "Please update the table to version 1.1"))
...
class STAT(dict, metaclass=mapmeta.FontDataMetaclass):
    ...
    test - WARNING - STAT is version 1.0 which has been deprecated. Please update the table to version 1.1
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> s = obj.binaryString()
        >>> utilities.hexdump(s)
               0 | 0001 0000 0008 0002  0000 0012 0002 0000 |................|
              10 | 0022 7465 7374 0123  0001 7767 6874 0100 |."test.#..wght..|
              20 | 0000 0004 0010 0001  0000 0000 0931 FFDE |.............1..|
              30 | 0000 0001 0001 0000  0931 FFDE 0000      |.........1....  |
        """
        ...
        w.add("H", _v1_0_DESIGN_AXIS_SIZE)
        w.add("H", len(self))
        w.add("L", 18)  # size of header
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        ...
        >>> logger = utilities.makeDoctestLogger('test')
        >>> s = ("00 01 00 00 00 08 00 01 00 00 00 12 00 01 00 00 "
        ...
        >>> s = ("00 01 00 15 00 08 00 01 00 00 00 12 00 01 00 00 "
        ...      "00 1A 74 65 73 74 01 23 00 01 00 02 00 01 00 00 "
        ...      "00 00 09 31 00 02 4C CD")
        >>> b = utilities.fromhex(s)
        >>> obj = STAT.fromvalidatedbytes(b, logger=logger)
        test.STAT - DEBUG - Walker has 40 remaining bytes.
        test.STAT.version - DEBUG - Walker has 40 remaining bytes.
        test.STAT - ERROR - Expected version 1.0, but got Major version = 1, Minor version = 21 instead.

        >>> s = ("00 01 00 00 08 00 00 01 00 00 00 12 00 01 00 00 "
        ...      "00 1A 74 65 73 74 01 23 00 01 00 02 00 01 00 00 "
        ...      "00 00 09 31 00 02 4C CD")
        >>> b = utilities.fromhex(s)
        >>> obj = STAT.fromvalidatedbytes(b, logger=logger)
        ...
        >>> s = ("00 01 00 00 00 08 00 05 00 00 00 12 00 01 00 00 "
        ...      "00 1A 74 65 73 74 01 23 00 01 00 02 00 01 00 00 "
        ...      "00 00 09 31 00 02 4C CD")
        >>> b = utilities.fromhex(s)
        >>> obj = STAT.fromvalidatedbytes(b, logger=logger)
        ...
        >>> s = ("00 01 00 00 00 08 00 01 00 00 00 12 00 00 00 00 "
        ...      "00 1A 74 65 73 74 01 23 00 01 00 02 00 01 00 00 "
        ...      "00 00 09 31 00 02 4C CD")
        >>> b = utilities.fromhex(s)
        >>> obj = STAT.fromvalidatedbytes(b, logger=logger)
        ...
        >>> s = ("00 01 00 00 00 08 00 01 00 00 00 12 00 01 00 00 "
        ...      "00 1A 74 65 73 74 01 23 00 01 00 02 00 01 02 00 "
        ...      "00 00 09 31 00 02 4C CD")
        >>> b = utilities.fromhex(s)
        >>> obj = STAT.fromvalidatedbytes(b, logger=logger)
        test.STAT - DEBUG - Walker has 40 remaining bytes.
        ...
        if version.major != 1 or version.minor != 0:
            logger.error((
              'V0002',
              (version,),
              "Expected version 1.0, but got %s instead."))
        ...
        if designAxisSize != _v1_0_DESIGN_AXIS_SIZE:
            logger.error((
              'V1077',
              (designAxisSize,),
        ...
        w.setOffset(-(designAxisCount * _v1_0_DESIGN_AXIS_SIZE), relative=True)  # back up
    ...
    def fromwalker(cls, w, **kwArgs):
        ...
        w.setOffset(-(designAxisCount * _v1_0_DESIGN_AXIS_SIZE), relative=True)
