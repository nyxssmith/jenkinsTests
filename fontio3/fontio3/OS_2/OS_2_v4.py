...
"""
Support for Version 4 OS/2 tables.
"""
...
class OS_2(object, metaclass=simplemeta.FontDataMetaclass):
    """
    Objects representing Version 4 OS/2 tables.
    ...
    def fromversion3(cls, v3Obj, **kwArgs):
        """
        Returns a new version 4 OS_2 object from the specified version 3
        ...
        r = cls(
          xAvgCharWidth = v3Obj.xAvgCharWidth,
          usWeightClass = v3Obj.usWeightClass,
          usWidthClass = v3Obj.usWidthClass,
          fsType = v3Obj.fsType,
          ySubscriptXSize = v3Obj.ySubscriptXSize,
          ySubscriptYSize = v3Obj.ySubscriptYSize,
          ySubscriptXOffset = v3Obj.ySubscriptXOffset,
          ySubscriptYOffset = v3Obj.ySubscriptYOffset,
          ySuperscriptXSize = v3Obj.ySuperscriptXSize,
          ySuperscriptYSize = v3Obj.ySuperscriptYSize,
          ySuperscriptXOffset = v3Obj.ySuperscriptXOffset,
          ySuperscriptYOffset = v3Obj.ySuperscriptYOffset,
          yStrikeoutSize = v3Obj.yStrikeoutSize,
          yStrikeoutPosition = v3Obj.yStrikeoutPosition,
          sFamilyClass = v3Obj.sFamilyClass,
          panoseArray = v3Obj.panoseArray,
          
          unicodeRanges = unicoderanges_v4.UnicodeRanges.fromversion3(
            v3Obj.unicodeRanges,
            **kwArgs),
          
          achVendID = v3Obj.achVendID,
          
          fsSelection = selection_v4.Selection.fromversion0(
            v3Obj.fsSelection,
            **kwArgs),
          
          usFirstCharIndex = v3Obj.usFirstCharIndex,
          usLastCharIndex = v3Obj.usLastCharIndex,
          sTypoAscender = v3Obj.sTypoAscender,
          sTypoDescender = v3Obj.sTypoDescender,
          sTypoLineGap = v3Obj.sTypoLineGap,
          usWinAscent = v3Obj.usWinAscent,
          usWinDescent = v3Obj.usWinDescent,
          codePageRanges = v3Obj.codePageRanges,
          sxHeight = v3Obj.sxHeight,
          sCapHeight = v3Obj.sCapHeight,
          usDefaultChar = v3Obj.usDefaultChar,
          usBreakChar = v3Obj.usBreakChar,
          usMaxContext = v3Obj.usMaxContext)
    ...
    def fromwalker(cls, w, **kwArgs):
        ...
        ver = w.unpack("H")
        assert ver == 4  # caller must be using the right class
        v = [ver]
        v.extend(w.unpack("H2h"))
    ...
    def asVersion3(self, **kwArgs):
        """
        Returns a Version 3 OS_2 object from self.
        """
        ...
        return OS_2_v3.OS_2(
          ...
          unicodeRanges = self.unicodeRanges.asVersion3(**kwArgs),
          achVendID = self.achVendID,
          fsSelection = self.fsSelection.asVersion0(**kwArgs),
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> utilities.hexdump(_testingValues[0].binaryString())
               0 | 0004 0000 0190 0005  0000 0000 0000 0000 |................|
        ...
        >>> utilities.hexdump(_testingValues[1].binaryString())
               0 | 0004 0258 0258 0008  0004 0000 0000 0000 |...X.X..........|
              10 | 0000 0000 0000 0000  0000 0000 0000 0000 |................|
        ...
        w.add("2h3H",
          self.sxHeight, self.sCapHeight, self.usDefaultChar, self.usBreakChar,
          self.usMaxContext)
