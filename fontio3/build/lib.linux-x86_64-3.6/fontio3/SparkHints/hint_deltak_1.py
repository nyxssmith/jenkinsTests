...
class Hint_DELTAK_1(set, metaclass=setmeta.FontDataMetaclass):
    """
    Objects representing Spark DELTAK1 opcodes. These are sets of DeltaSpec
    objects.
    """
    ...
    def __str__(self):
        ...
        ...   hint_deltaspec.DeltaSpec(12, 38, -0.125),
        ...   hint_deltaspec.DeltaSpec(15, 38, 0.25)})
        >>> print(obj)
        DELTAK: Point 31 -1/8@12, 1/4@15; Point 38 -1/8@12, 1/4@15
        """
    ...
    def _makeDict(self):
        ...
        >>> sorted(d)
        [31, 38]
        >>> obj.add(hint_deltaspec.DeltaSpec(14, 31, -0.125))
        >>> d = obj._makeDict()
    ...
    def buildBinary(self, w, **kwArgs):
        ...
        >>> utilities.hexdump(obj.binaryString(**d))
               0 | A702 001F 0026 0237  69                  |.....&.7i       |
        """
        
        band = 1  # hardwired for Hint_DELTAK_1
    ...
    def decompose(self):
        """
        Returns a list of Hint_DELTAK_1 objects matching self, but where each
        ...
        ...     print(part)
        DELTAK: Point 31 -1/8@12
        DELTAK: Point 38 -1/8@12
        DELTAK: Point 31 1/4@15
        DELTAK: Point 38 1/4@15
        """
    ...
    def fromvalidatedwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAK_1 from the specified walker, with validation.
        ...
        >>> fvb = Hint_DELTAK_1.fromvalidatedbytes
        >>> bs = utilities.fromhex("A7 02 00 1F 00 26 02 37 69")
        ...
        if op != 0xA7:
            logger.error((
              'V0002',
              (op,),
              "Was expecting opcode 0xA7, but got 0x%02X instead"))
    ...
    def fromwalker(cls, w, **kwArgs):
        """
        Returns a new Hint_DELTAK_1 from the specified walker.
